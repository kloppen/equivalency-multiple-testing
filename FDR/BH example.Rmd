---
title: "Sample Code for Benjamini-Hochberg Procedure"
...
related to Benjamini-Hochberg's method for control of the False Discovery Rate.
                                 ...
                                 rho = 0.5)
{
  ...
  repeat_iterations = function(i)
  {
    ...
    BH_significance_levels = nominal_significance_level*
                             ((1:number_endpoints)/number_endpoints)
    rejection_indicators = as.numeric(ordered_p_values<=
                                      BH_significance_levels)
